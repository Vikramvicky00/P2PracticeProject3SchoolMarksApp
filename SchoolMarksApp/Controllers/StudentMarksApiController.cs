...
using SchoolMarksApp;

namespace SchoolMarksApp.Controllers
{
    public class StudentMarksApiController : ApiController
    {
        private StudentDbEntities db = new StudentDbEntities();

        // GET: api/StudentMarksApi
        public IQueryable<StudentMark> GetStudentMarks()
        {
            return db.StudentMarks;
        }

        // GET: api/StudentMarksApi/5
